...
<head>
  ...
  <link rel="stylesheet" href="/static/homepage/css/bootstrap.css" type="text/css" />
  <link rel="stylesheet" href="/static/homepage/style.css" type="text/css" />
  <link rel="stylesheet" href="/static/homepage/css/dark.css" type="text/css" />

  <!-- Media Agency Demo Specific Stylesheet -->
  <link rel="stylesheet" href="/static/homepage/demos/app-landing/app-landing.css" type="text/css" />
  <!-- / -->

  <link rel="stylesheet" href="/static/homepage/css/font-icons.css" type="text/css" />
  <link rel="stylesheet" href="/static/homepage/one-page/css/et-line.css" type="text/css" />
  <link rel="stylesheet" href="/static/homepage/css/animate.css" type="text/css" />
  <link rel="stylesheet" href="/static/homepage/css/magnific-popup.css" type="text/css" />

  <link rel="stylesheet" href="/static/homepage/demos/app-landing/css/fonts.css" type="text/css" />

  <!-- Bootstrap Switch CSS -->
  <link rel="stylesheet" href="/static/homepage/css/components/bs-switches.css" type="text/css" />

  <link rel="stylesheet" href="/static/homepage/css/responsive.css" type="text/css" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />

  <link rel="stylesheet" href="/static/homepage/demos/app-landing/css/colors.css" type="text/css" />
...
<body class="stretched">
  ...
  <div id="wrapper" class="clearfix">
    ...
    <header id="header" class="split-menu transparent-header dark" data-sticky-class="not-dark" data-responsive-class="not-dark">
      ...
      <div id="header-wrap">
        ...
        <div class="container clearfix">
          ...
          ============================================= -->
          <div id="logo">
            <a href="index.html" style="float:left;" class="standard-logo" data-dark-logo="/static/classic/topbar/assets/images/logo.svg"><img src="/static/classic/topbar/assets/images/logo.svg" alt="Canvas Logo"></a>
            <a href="index.html" class="retina-logo" data-dark-logo="/static/classic/topbar/assets/images/logo.svg"><img src="/static/classic/topbar/assets/images/logo.svg" alt="Canvas Logo"></a>
          </div><!-- #logo end -->
    ...
    <section id="slider" class="full-screen slider-parallax">
      <div class="slider-parallax-inner" style="background: url('/static/homepage/images/landing/landing1.jpg') center center no-repeat; background-size: cover;">
          ...
          <div class="container dark clearfix">
            <div class="row clearfix">
              <div class="col-md-6 col-sm-8">
                ...
                <a href="#" data-scrollto="#section-pricing" data-easing="easeInOutExpo" data-speed="1250" data-offset="160" class="button button-large button-white button-light capitalize" style="border-radius: 23px;">Try it Free</a>
    ...
    <section id="content">
      ...
      <div class="content-wrap">
        ...
        <div class="container clearfix">
          ...
          <div id="section-nextgen" class="page-section bottommargin-lg">
            <div class="row clearfix">
              ...
              <div class="col-md-7 center">
                <img src="/static/homepage/demos/app-landing/images/section/iphone-watch.png" alt="NextGen Framework" data-animate="fadeInLeft">
              </div>

              <div class="col-md-5">
                <div class="topmargin-lg hidden-xs hidden-sm"></div>
                <img src="/static/homepage/demos/app-landing/images/section/section-1-icon.png" alt="" style="display: block;" class="bottommargin-sm">
                <div class="emphasis-title bottommargin-sm">
                  <span class="before-heading">Plug into the</span>
                  <h2 style="font-size: 42px;" class="font-body ls1 t400">Responsive Ready</h2>
                </div>
                <p style="color: #777;" class="lead">Powerful Builder with Responsive functionality to make your CV instantly on Mobile.</p>
          ...
          <div id="section-stunning-graphics" class="page-section topmargin bottommargin-lg">
            <div class="row clearfix">
              ...
              <div class="col-md-5">
                <div class="topmargin-lg hidden-xs hidden-sm"></div>
                <img src="/static/homepage/demos/app-landing/images/section/section-2-icon.png" alt="" style="display: block;" class="bottommargin-sm">
                <div class="emphasis-title bottommargin-sm">
                  <span class="before-heading">Retina Ready &#x7E; 534 PPI</span>
                  <h2 style="font-size: 42px;" class="font-body ls1 t400">Flexible Options</h2>
                </div>
                <p style="color: #777;" class="lead">Amazing set of customizable options giving you opportunity to quickly create & edit</p>
                <a href="#" class="section-more-link">Learn More <i class="icon-angle-right"></i></a>
              </div>

              <div class="col-md-7 center">
                <img src="/static/homepage/demos/app-landing/images/section/iphone-nexus.png" alt="Stunning Graphics" data-animate="fadeInRight">
              </div>
        ...
        <div id="section-secured-solutions" class="page-section section nopadding topmargin-sm" style="background: url('/static/homepage/demos/app-landing/images/section/iphone-3d-bg.png') no-repeat left bottom; background-size: 100% auto;" data-height-lg="700" data-height-md="700" data-height-sm="450" data-height-xs="450" data-height-xxs="450">
          <div class="container clearfix">
            <div class="row clearfix">
              <div class="col-md-5 col-md-offset-6">
                <div class="topmargin-lg hidden-xs hidden-sm"></div>
                <div class="topmargin-lg hidden-xs hidden-sm"></div>
                <img src="/static/homepage/demos/app-landing/images/section/section-3-icon.png" alt="" style="display: block;" class="bottommargin-sm">
                <div class="emphasis-title bottommargin-sm">
                  <span class="before-heading">Privacy Protected</span>
                  <h2 style="font-size: 42px;" class="font-body ls1 t400">Recruiter Preferred Templates</h2>
                </div>
                <p style="color: #777;" class="lead">CV Owl includes few, but Recruiter Preferred CV templates</p>
                <a href="#" class="section-more-link">Learn More <i class="icon-angle-right"></i></a>
              </div>
            </div>
          </div>
          <div class="video-wrap" style="position: absolute; height: 100%; z-index: 1;">
            <div class="video-overlay hidden-xs hidden-sm" style="background: url('/static/homepage/demos/app-landing/images/section/iphone-3d.png') no-repeat left top; background-size: auto 100%;" data-animate="fadeInLeft"></div>
          </div>
        </div>
              ...
              <div class="slider-wrap divcenter" style="max-width: 650px;">
                <div class="slide">
                  <div class="testi-image">
                    <a href="#"><img src="/static/homepage/images/testimonials/3.jpg" alt="Customer Testimonails"></a>
                  </div>
                ...
                <div class="slide">
                  <div class="testi-image">
                    <a href="#"><img src="/static/homepage/images/testimonials/2.jpg" alt="Customer Testimonails"></a>
                  </div>
                  <div class="testi-content">
                ...
                <div class="slide">
                  <div class="testi-image">
                    <a href="#"><img src="/static/homepage/images/testimonials/1.jpg" alt="Customer Testimonails"></a>
                  </div>
                  <div class="testi-content">
        ...
        <div id="section-gallery" class="page-section nopadding nomargin">
          ...
          <div class="owl-carousel owl-carousel-full image-carousel carousel-widget bottommargin" data-margin="20" data-center="true" data-loop="true" data-nav="false" data-pagi="true" data-items-xxs="2" data-items-xs="2" data-items-sm="4" data-items-md="4" data-items-lg="6" data-stage-padding="30" data-lightbox="gallery">
            ...
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-1.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-1.jpg" alt="Image 1"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-2.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-2.jpg" alt="Image 2"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-3.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-3.jpg" alt="Image 3"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-4.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-4.jpg" alt="Image 4"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-5.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-5.jpg" alt="Image 5"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-6.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-6.jpg" alt="Image 5"></a>
            </div>
            <div class="oc-item">
              <a data-lightbox="gallery-item" href="/static/homepage/demos/app-landing/images/gallery/img-7.jpg"><img src="/static/homepage/demos/app-landing/images/gallery/img-7.jpg" alt="Image 5"></a>
            </div>
              ...
              <div class="widget clearfix">
                <div class="row clearfix">
                  <div class="col-md-8 bottommargin-sm clearfix" style="color:#888;">
                    <img src="/static/homepage/demos/app-landing/images/footer-logo.png" alt="Canvas Logo" style="display: block;" class="bottommargin-sm">
  ...
  ============================================= -->
  <script type="text/javascript" src="/static/homepage/js/jquery.js"></script>
  <script type="text/javascript" src="/static/homepage/js/plugins.js"></script>

  <!-- Footer Scripts
  ============================================= -->
  <script type="text/javascript" src="/static/homepage/js/functions.js"></script>
