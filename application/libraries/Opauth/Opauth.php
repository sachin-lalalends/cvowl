...
class Opauth {
	...
	public function __construct($config = array(), $run = true) {
		...
		$this->config = array_merge(array(
			...
			'path' => '/auth/login/',
			'callback_url' => 'https://cvdexter-mycollege.c9users.io/home/login_callback_linkedin/',
			'callback_transport' => 'post',
			'debug' => false,
			'security_salt' => 'LDFmiilYf8Fyw5W10rx4W1KsVrieQCnpBzipTBWA5vJidQKDx8pMJbmw28R1C4m',
			'security_iteration' => 300,
			'security_timeout' => '2 minutes',
			'Strategy' => array(
			    'LinkedIn' => array(
		            'api_key' => '75fxauc3or09bv',
		            'secret_key' => 'jzfsDj3fBHdLZ0du'
		        )
		    )
		), $config);
	...
	private function parseUri() {
		...
		// By mayank to force it to go to linkedin instead of passing from front
		$this->env['params'][0] = "linkedin";
