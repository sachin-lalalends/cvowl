...
refresh();
  function refresh() {
    $.post('/cv/getinfo',{'get':'CERTIFICATIONS'},function(data)
    {
      ...
      else
      {
          ...
          expstr += '<a class="list-group-item" href="javascript:void(0)" >'+
                '<div class="media">'+
                  '<div class="media-left">'+
                    ...
                    '</div>'+
                  '</div>'+
                  '<div class="media-body" data-1="'+v.id+'" data-2="'+v.section_title1+'" data-3="'+v.end_date+'" data-4="'+v.more_info1+'" data-5="'+v.section_title2+'" data-6="'+v.section_title3+'" data-7="" data-8="">'+
        ...
        expstr += '<button type="button" class="btn btn-sm btn-outline btn-default width-250 font-weight-400 center-block form-handle margin-top-20"><i class="icon wb-plus"></i>&nbsp;Add Certifications</button>';
        $('.prevcerti').html(expstr);
        $('.prevcerti').show();
        $('.certiform').hide();
        $('.tab-pane').css('opacity','1');
        ...
        {
          $('.form-handle').hide();
          $('.certiform').slideDown('fast', function()
          {
            $('.tab-pane').asScrollable('update');
          });
        });
        $('div.media-body').on('click', function(e)
        {
          ...
          else
          {
            ...
            $(".ecele").val($(this).data('2'));
            $(".eiser").val($(this).data('5'));
            $(".eloon").val($(this).data('6'));
            var res = $(this).data('3').split('-');
            $(".eenmn").val(res[0]);
            $(".eenyr").val(res[1]);
            $(".edeon").html($(this).data('4'));
            $('.form-handle').hide();
            $('.certiform').slideUp();
            $('.editform').slideDown();
        ...
        $("i.delete-exp").on('click', function(e)
        {
          if(flag)
          {
            ...
            param.section_type = 'CERTIFICATIONSDEL';
            param.id = updid;
            flag = 0;
            $.post('/cv/fillinfo',{'param':param},function(data)
            {
              $('.certiform').trigger('reset');
              refresh();
              flag = 1;
              buildresume();
            });
  ...
  $('.refresh').on('click', function()
  {
    if(flag)
    {
      ...
      flag = 0;
      var param = {};
      param.section_type = 'CERTIFICATIONS';
      param.section_title1 = $(".cele").val();
      param.section_title2 = $(".iser").val();
  ...
  $('.update').on('click', function()
  {
    if(flag)
    {
      ...
      var param = {};
      param.id = $(".eid").html();
      param.section_type = 'CERTIFICATIONSUPD';
      param.section_title1 = $(".ecele").val();
      param.section_title2 = $(".eiser").val();
  ...
  if($(window).width() < 765)
   {
     $('.nav-tabs').addClass('site-sidebar-nav')
   }
</script>
...
<img width="30px" data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/sections.tpl" src="data:image/png;base64,">&nbsp;&nbsp;
  ...
  <li role="presentation">
    <a>
      <i class="icon wb-chevron-left" style="cursor:pointer;" data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/ACHIEVEMENTS_new.tpl"></i>
      <span style="font-weight:500;color:#66AAEA;border-bottom: 2px solid #62a8ea;">CERTIFICTAIONS</span>
    </a>
  </li>
  <li style="cursor:pointer;font-weight:400;" role="presentation">
    <a data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/LANGUAGES.tpl" style="background: -webkit-linear-gradient(left,#76838F, #fff);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">LANGUAG
    </a>
  </li>
  ...
  <div class="tab-pane fade active in" id="sidebar-editing" style="opacity:0;">
      ...
      <div class="">
        <div class="">
          ...
          <br><br>
          <div class="list-group prevcerti">
          </div>
          
          <form class="certiform">
            
            <div class="form-group form-material floating">
              <input type="text" class="form-control empty cele" />
              <label class="floating-label">TITLE</label>
            </div>
            
            <div class="form-group form-material floating">
              <input type="text" class="form-control empty iser" />
              <label class="floating-label">ISSUER</label>
            </div>
            ...
            <div class="form-group form-material row ">
                <button type="button" class="btn btn-sm btn-outline btn-primary refresh width-250 font-weight-500 center-block">SAVE</button>
            </div>
          ...
          <form class='editform margin-top-20' style="display:none">
            ...
            <div class="form-group form-material floating">
              <input type="text" class="form-control ecele" />
              <label class="floating-label">Certificate Title</label>
            </div>
            
            <div class="form-group form-material floating">
              <input type="text" class="form-control empty eiser" />
              <label class="floating-label">ISSUER</label>
            </div>
