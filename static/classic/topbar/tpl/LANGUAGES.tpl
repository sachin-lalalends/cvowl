...
<script>
  ...
  function refresh() {
    ...
    $.each(Data.Language, function(k, v) {
      if (v != null && v.section_type == "LANGUAGE") {
        ...
        temp += '<div class="form-group form-material row">' +
          ...
          '<div class="col-xs-5">' +
          '<input type="text" class="form-control empty esec1" placeholder="Language Name" onkeyup="updateRecord('+k+',this);" value="' + v.section_title1 + '">' +
          '</div>' +
          '<div class="col-xs-5">' +
          '<select class="form-control empty esec2"  onchange="updateRecord('+k+',this);">' +
          '<option selected disabled>Proficiency </option>' +
          '<option value="Elementary"';
        if (v.section_title2 == "Elementary") {
          temp += 'selected';

        }
        temp += '>Elementary</option>' +
          '<option value="Limited"';
        if (v.section_title2 == "Limited") {
          temp += 'selected';

        }
        temp += '>Limited</option>' +
          '<option value="Professional"';
        if (v.section_title2 == "Professional") {
          temp += 'selected';

        }
        temp += '>Professional</option>' +
          '<option value="Native"';
        if (v.section_title2 == "Native") {
          temp += 'selected';
    ...
    //temp += '<button type="button" class="btn btn-sm btn-outline btn-default width-250 font-weight-400 center-block addnewBtn margin-top-20 margin-bottom-50"><i class="icon wb-plus"></i>&nbsp;Add Language</button>';
  ...
  function updateRecord(key,context) {
    ...
    if (Data.Language[key] != null && Data.Language[key].section_type == "LANGUAGE") {
      if($(context).hasClass('esec1')){
        ...
        $('[data-for="LANG-' + key + '"] .E1').html(context.value + " ("+ Data.Language[key].section_title2 + ")");
      }else if($(context).hasClass('esec2')){
        $('[data-for="LANG-' + key + '"] .E1').html(Data.Language[key].section_title1 + " ("+context.value+ ")");
        Data.Language[key].section_title2 = context.value;
      }
      else{
        return false;
      }
...
<div class="nav_tab_container">
  ...
  <div style="float:left;width:64%;line-height: 45px;">
    ...
    <ul class="site-sidebar-nav nav nav-tabs nav-justified nav-tabs-line scrollable scrollable-horizontal" role="tablist" >
      ...
      <li style="cursor:pointer;font-weight:400;" role="presentation" >
        <a class="active_menu" data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/LANGUAGES.tpl"><span>LANGUAGES</span>
        </a>
      </li>
      <li style="cursor:pointer;font-weight:400;" role="presentation">
...
<div class="site-sidebar-tab-content tab-content">
  ...
  <div class="tab-pane fade active in" id="sidebar-editing" style="opacity:0;">
    ...
    <div class="">
      <div class="">
        <span class="slidePanel-desc">Enter the languages that you can speak or write.</span>
        <br>
        <br>
        ...
        <div class="row margin-bottom-50 margin-top-50">
          ...
          <div class="col-sm-5 col-xs-5">
            <button type="button" class="btn btn-block btn-warning font-weight-400" style="letter-spacing:.1em;" data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/HOBBIES.tpl">NEXT&nbsp; <i class="fa fa-chevron-right"></i> </button>
          </div>
        </div>
      </div>
    </div>
