...
<script>
  ...
  function init() {
    ...
    $('#cs_name').html(activeSection);
    Data[activeSection].sort(function(a, b) {
  ...
  function refresh() {
    ...
    var id = 0;
    $.each(Data[activeSection], function(k, v) {
      if (v != null && v.section_type == activeSection.toUpperCase()) {
    ...
    temp += '<button type="button" class="btn btn-sm btn-outline btn-default width-250 font-weight-400 center-block addnewBtn margin-top-20 margin-bottom-50"><i class="icon wb-plus"></i>&nbsp;Add '+activeSection.toLowerCase()+'</button>';
    ...
    $(".allowSort").sortable({
      ...
      update: function(event, ui) {
        ...
        $.each(sectionOrder, function(k, v) {
          if (v != "") {
            Data[activeSection][v].order_prefs = orderpref;
            orderpref++;
          }
        });
    ...
    $('div.media-body').on('click', function(e) {
      ...
      if ($('.editform').is(':visible')) {
        ...
        $(".eimg").attr('src',"/static/classic/topbar/assets/images/chars/"+Data[activeSection][$(this).data('1')].section_title2.charAt(0).toUpperCase()+".png");
        $(".esec2").val(Data[activeSection][$(this).data('1')].section_title1);
        $(".esec1").val(Data[activeSection][$(this).data('1')].section_title2);
        $(".esec3").val(Data[activeSection][$(this).data('1')].section_title3);
        var res = Data[activeSection][$(this).data('1')].start_date.split(' ');


        $(".estmn").val($.trim(res[0]));
        $(".estyr").val($.trim(res[1]));
        res = Data[activeSection][$(this).data('1')].end_date.split(' ');
        ...
        $(".edeon").val(Data[activeSection][$(this).data('1')].more_info1);
        $(".edeon").summernote();
        ...
        $('.eprnt').on("change", function() {
          if ($(".eprnt").prop('checked') == true) {
            ...
            $(".eenmn").prop('disabled', true);
            $(".eenyr").prop('disabled', true);
            $('[data-for="EXP-' + $('.eid').html() + '"] .F6').html($('.estmn').val()+" "+$('.estyr').val()+" to PRESENT");
          }
          else {
            $(".eenmn").prop('disabled', false);
            $(".eenyr").prop('disabled', false);
            $('[data-for="EXP-' + $('.eid').html() + '"] .F6').html($('.estmn').val()+" "+$('.estyr').val());
          }
        });
        ...
        $('.esec2').on("keyup", function() {
          $('[data-for="EXP-' + $('.eid').html() + '"] .F1').html($('.esec2').val());
        });

        $('.esec3').on("keyup", function() {
          $('[data-for="EXP-' + $('.eid').html() + '"] .F2').html($('.esec3').val());
        });

        $('.esec1').on("keyup", function() {
          $('[data-for="EXP-' + $('.eid').html() + '"] .F3').html($('.esec1').val().toUpperCase());
        });
        
        $('.estyr, .estmn, .eenmn, .eenyr').on("change", function() {
          $('[data-for="EXP-' + $('.eid').html() + '"] .F6').html($('.estmn').val()+" "+$('.estyr').val()+" to "+ $('.eenmn').val()+" "+$('.eenyr').val());
        });

        $('.edeon').on("keyup", function() {
          $('[data-for="EXP-' + $('.eid').html() + '"] .F5').html($(".edeon").code());
        });
  ...
  var param = {
    ...
    section_title4: null,
    section_title5: null,
    section_type: activeSection.toUpperCase(),
    start_date: null
  };
  ...
  function updateRecord(key) {
    ...
    if (Data[activeSection][key] != null && Data[activeSection][key].section_type == activeSection.toUpperCase()) {
      Data[activeSection][key].section_type = activeSection.toUpperCase();
      Data[activeSection][key].section_title1 = $(".esec2").val();
      Data[activeSection][key].section_title2 = $(".esec1").val();
      Data[activeSection][key].section_title3 = $(".esec3").val();
      Data[activeSection][key].start_date = $(".estmn").val() + ' ' + $(".estyr").val();
      if ($('.eprnt').is(":checked")) {
        Data[activeSection][key].end_date = 'Present';
      }
      else {
        Data[activeSection][key].end_date = $(".eenmn").val() + ' ' + $(".eenyr").val();
      }
      Data[activeSection][key].more_info1 = $(".edeon").code();
      localStorage.setItem("data", JSON.stringify(Data));
      refresh();
      return false;
    }
  ...
  function changeVisibility(key, status) {
    ...
    if (status == 1) {
      Data[activeSection][key].is_active = 0;
    }
    else {
      Data[activeSection][key].is_active = 1;
    }
    localStorage.setItem("data", JSON.stringify(Data));
    buildresume();
    refresh();
...
<ul class="site-sidebar-nav nav nav-tabs nav-justified nav-tabs-line" role="tablist">
  <li style="cursor:pointer;" role="Presentation">
    <a style="text-align:left;margin-left: 10px;" data-toggle="slidePanel" aria-hidden="true" data-url="../../static/classic/topbar/tpl/sections.tpl" >
      &nbsp;&nbsp;&nbsp;&nbsp;
...
<img src="data:image/png;base64,">&nbsp;&nbsp;
  ...
  <li role="Presentation">
    <a  style="text-align:left;margin-left: -40px;">
      <span style="font-weight:500;color:#66AAEA;border-bottom: 2px solid #62a8ea;" id="cs_name">CUSTOM SECTION</span>
    </a>
  </li>
</ul>
...
<div class="site-sidebar-tab-content tab-content">
  ...
  <div class="tab-pane fade active in" id="sidebar-editing" style="opacity:0;">
    ...
    <div class="">
      ...
      <div class="">
        <span class="slidePanel-desc">Showcase anything extra you want to include in your resume e.g. affiliations, extra curricular activities, workshops, online courses</span>
        <br>
        <br>
        ...
        <form class='newForm margin-bottom-50 padding-10' style="margin-right: -10px; margin-left: -10px;">
          <div class="newForm-header" style="margin: -10px;margin-bottom:15px;">
            <span class="new-heading pull-right" style=" margin-top: -10px; line-height: 25px; text-align: right;">
              <i class="fa fa-close" style="font-color:red;cursor:pointer;"></i><br>ADD
            </span>
            <div class="avatar avatar-sm" style="width:35px;">
          ...
          <div class="form-group form-material floating">
            ...
            <label class="floating-label">Sub-Title 1</label>
          </div>
          
          <div class="form-group form-material floating">
            <input type="text" class="form-control empty sec3" />
            <label class="floating-label">Sub-Title 2</label>
          </div>
